...
import 'package:encryption_test/audioplayer/now_playing.dart';
...
class _MiniPlayerState extends State<MiniPlayer> {
          ...
          builder: (context, prefSnapshot) {
            ...
            return Container(
              ...
              child: ListTile(
                ...
                title: Text('select music to play.'),
  ...
  play(MediaItem mediaItem, SharedPreferences prefs) {
    if (!AudioService.running && prefs != null) {
      final items = Provider.of<MusicService>(context, listen: false).items;
